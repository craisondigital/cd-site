...
<head>
  ...
  <title>Craison Digital – Lake Fountain Control Packages & Pricing</title>
  <meta name="description" content="Smart lake fountain control packages for residential properties. Phone control, wind protection, LED scheduling, and full automation — choose what you need."/>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .status-warn{background:rgba(250,204,21,0.08);color:#facc15;border:1px solid rgba(250,204,21,0.18)}
...
<body>
  ...
  <!-- ── NAV v5 — simplified, site-wide only ── -->
  <?php $activePage = 'fountain-pricing'; ?>
<?php include 'nav.php'; ?>
  ...
  <section id="packages">
    ...
    <h2 class="section-title">Is your fountain <em style="font-style:normal;background:linear-gradient(135deg,var(--blue-bright),var(--cyan));-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">running?</em></h2>

    <!-- Notification toast - cycles through different fountain scenarios -->
    <div style="margin-bottom:2rem;text-align:center;">
      <div class="notif-toast" id="pricingToast" style="opacity:1;transform:none;position:relative;display:inline-flex;transition:opacity 0.4s ease;">
        ...
        <div class="notif-body">
          <div class="notif-title" id="toastTitle">Sunset mode activated</div>
          <div class="notif-sub" id="toastSub">Fountain &amp; LEDs on · 7:32 PM</div>
        </div>
        <div class="notif-badge" id="toastBadge">✓ Scheduled</div>
      </div>
    </div>
    ...
    <div class="packages-grid">
      ...
      <div class="pkg-card">
        ...
        <div class="pkg-tagline">Turn your fountain and LEDs on and off from your phone — from anywhere. Set schedules so it runs on its own.</div>
        ...
        <ul class="pkg-features">
          <li>Control fountain pump from your phone</li>
          <li>Control fountain LEDs from your phone</li>
          <li>Set custom on/off schedules</li>
          <li>Works with Siri, Alexa &amp; Google Home</li>
          <li><a href="#addons" style="color:var(--text);text-decoration:none;">Compatible with Home Assistant</a></li>
          <li>Share access with family members</li>
          <li class="muted-feature">No wind protection</li>
          <li class="muted-feature">No weather monitoring</li>
        </ul>
        <div class="pkg-cta"><a href="#contact" class="btn-primary">Get a Quote →</a></div>
        <div class="pkg-note">Works with your existing fountain.<br/>WiFi or Bluetooth.</div>
      </div>

      <!-- WEATHER PROTECTED -->
      <div class="pkg-card featured">
        <div class="pkg-badge">Recommended</div>
        <div class="pkg-icon-large"><svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 14 C12 14 18 14 22 14 C26 14 28 12 28 9" stroke="var(--cyan)" stroke-width="2" stroke-linecap="round"/><path d="M4 22 C14 22 24 22 30 22 C34 22 36 19 36 15" stroke="var(--cyan)" stroke-width="2" stroke-linecap="round"/><path d="M8 30 C14 30 20 30 24 30 C27 30 28 28 28 25" stroke="var(--cyan)" stroke-width="2" stroke-linecap="round"/></svg></div>
        <div class="pkg-name">Weather Protected</div>
        <div class="pkg-tagline">Everything in Phone Control, plus a local weather station that automatically shuts off the fountain in high winds.</div>
        <div class="pkg-price-block">
        ...
        <div class="pkg-divider"></div>
        <ul class="pkg-features">
          <li>Everything in Phone Control, plus:</li>
          <li>Local weather station installed on-site</li>
          <li>Auto-shutoff when wind exceeds threshold</li>
          <li>Protects vehicles, buildings &amp; landscaping from overspray on windy days</li>
          <li>Wind speed &amp; gust monitoring</li>
          <li>App notifications when wind shuts off fountain</li>
        </ul>
        <div class="pkg-cta"><a href="#contact" class="btn-primary">Get a Quote →</a></div>
        <div class="pkg-note">Works with your existing fountain.<br/>Solar powered weather station with battery backup.</div>
      </div>
    </div>

    <div class="packages-footnote">
      <p>Every package works with your existing fountain equipment — we add smart control to the setup you already have. Pricing includes hardware, professional installation, full system configuration, and a walkthrough. We'll confirm your quote after a free property assessment.</p>
    </div>
  </div></section>

  <!-- ── PHOTO BANNER ── -->
  <div class="photo-banner">
    <img src="img/fountain_day.png" alt="Lake fountain" loading="lazy"/>
    <div class="photo-banner-overlay">
      <div class="photo-banner-text">
        <h2>What happens to your fountain when it's windy?</h2>

        <p>No app? No schedule? No wind protection? <span style="color:var(--blue-bright);font-weight:500;">There's a better way.</span></p>
  ...
  <section id="addons"><div class="section-inner">
    ...
    <h2 class="section-title">Enhance any package.</h2>
    ...
    <div class="how-grid">
      <div class="how-card">
        <img class="how-card-img" src="img/fountain_phone.png" alt="Fountain phone control" loading="lazy"/>
        <div class="how-card-body">
        <h3>Fountain Phone Control</h3>
        <p>A compact smart relay is wired to your fountain pump and connects to your WiFi, giving you full on/off control from your phone — from anywhere. Set custom schedules, share access with family, and use voice control with Siri, Alexa, or Google Home.</p>
        </div>
      </div>
      <div class="how-card">
        <img class="how-card-img" src="img/fountain_night.png" alt="Fountain LED lights at night" loading="lazy"/>
        <div class="how-card-body">
        <h3>LED Light Control</h3>
        <p>A second smart relay controls your fountain's LED lights independently from the pump. Turn lights on for ambiance even when the fountain is off, or set them to automatically activate at sunset whenever the fountain is running. Controlled from the same app.</p>
        </div>
      </div>
      <div class="how-card">
        <img class="how-card-img" src="img/weather_station.png" alt="Local weather station" loading="lazy"/>
        <div class="how-card-body">
        <h3>Local Weather Station</h3>
        <p>A solar-powered 7-in-1 weather station is installed on your property. It measures wind speed, gusts, temperature, humidity, rain, UV, and barometric pressure — all in real time. When wind exceeds your set threshold, the fountain shuts off automatically to prevent damage. No moving parts, no maintenance.</p>
        </div>
      </div>
      <div class="how-card">
        ...
        <p>Your fountain is just one piece of your property. Home Assistant brings everything — gate access, pool, lights, cameras, irrigation — into a single app on your phone. One dashboard, one system, no juggling five apps from five different vendors.</p>
      ...
      <div class="how-card" id="wireless-bridge">
        <!-- SWAP: Replace with photo of wireless bridge antennas -->
        ...
        <p>No internet at the fountain? Our wireless bridge extends your home WiFi up to 3,280 feet away. Two weatherproof antennas are mounted with line of sight — one at the house, one at the fountain. Required only if you want remote control, push notifications, or voice assistant integration and don't have WiFi reaching the fountain.</p>
  ...
  <section id="faq"><div class="section-inner">
    ...
    <div class="faq-list">
      <div class="faq-item">
        <button class="faq-q" onclick="toggleFaq(this)">Do I need internet at the fountain? <svg width="14" height="8" viewBox="0 0 14 8"><path d="M1 1l6 6 6-6" stroke="currentColor" fill="none" stroke-width="1.5" stroke-linecap="round"/></svg></button>
        <div class="faq-a"><p>Not at all — everything works over Bluetooth when you're near the fountain. But with WiFi, you get remote control from anywhere, push notifications, and voice assistant integration. If your WiFi doesn't reach the fountain, our <a href="#wireless-bridge" style="color:var(--blue-bright);text-decoration:none;">wireless bridge</a> add-on extends it up to 3,280 feet.</p></div>
      </div>
      <div class="faq-item">
        <button class="faq-q" onclick="toggleFaq(this)">How does the wind protection work? <svg width="14" height="8" viewBox="0 0 14 8"><path d="M1 1l6 6 6-6" stroke="currentColor" fill="none" stroke-width="1.5" stroke-linecap="round"/></svg></button>
        <div class="faq-a"><p>A local weather station monitors wind speed and gusts in real time. When wind exceeds your set threshold, the fountain shuts off automatically to prevent overspray. When conditions calm down, it can be configured to restart on its own — or you can restart it manually from the app whenever you're ready.</p></div>
      </div>
      <div class="faq-item">
      ...
      <div class="faq-item">
        <button class="faq-q" onclick="toggleFaq(this)">Can I control the fountain LEDs separately from the pump? <svg width="14" height="8" viewBox="0 0 14 8"><path d="M1 1l6 6 6-6" stroke="currentColor" fill="none" stroke-width="1.5" stroke-linecap="round"/></svg></button>
        <div class="faq-a"><p>Yes — the pump and LEDs are on separate smart relays, so you have independent control of each. Turn on the lights for evening ambiance without running the fountain, or run the fountain during the day without the lights. You can also set the LEDs to auto-on at sunset whenever the fountain is running.</p></div>
      </div>
      <div class="faq-item">
        ...
        <div class="faq-a"><p>The smart relays remember their last state and reconnect automatically when power is restored. Your schedules and automations resume on their own — no reconfiguration needed. The weather station runs on solar power with a battery backup, so it continues monitoring even during outages.</p></div>
      </div>
      <div class="faq-item">
        <button class="faq-q" onclick="toggleFaq(this)">Can I start with Phone Control and upgrade later? <svg width="14" height="8" viewBox="0 0 14 8"><path d="M1 1l6 6 6-6" stroke="currentColor" fill="none" stroke-width="1.5" stroke-linecap="round"/></svg></button>
        <div class="faq-a"><p>Yes. Every package is designed to build on the one before it. Start with Phone Control, add the weather station later for wind protection, or add Home Assistant when you're ready to integrate your fountain with the rest of your property. Nothing gets replaced — we just add to what's already there.</p></div>
      </div>
      <div class="faq-item">
        <button class="faq-q" onclick="toggleFaq(this)">What if I want to control more than just the fountain? <svg width="14" height="8" viewBox="0 0 14 8"><path d="M1 1l6 6 6-6" stroke="currentColor" fill="none" stroke-width="1.5" stroke-linecap="round"/></svg></button>
        <div class="faq-a"><p>Add our <a href="#addons" style="color:var(--blue-bright);text-decoration:none;">Home Assistant integration</a> to any package. It ties your fountain into a single dashboard alongside your gate, pool, lights, cameras, and anything else on your property. One app for everything. <a href="#contact" style="color:var(--blue-bright);text-decoration:none;">Let's talk about what's possible.</a></p></div>
      </div>
      <div class="faq-item">
        <button class="faq-q" onclick="toggleFaq(this)">Do you work with existing fountain setups? <svg width="14" height="8" viewBox="0 0 14 8"><path d="M1 1l6 6 6-6" stroke="currentColor" fill="none" stroke-width="1.5" stroke-linecap="round"/></svg></button>
        <div class="faq-a"><p>Yes. We add smart control to the fountain equipment you already have — no rip and replace. We wire smart relays to your existing pump and LED circuits. <a href="#contact" style="color:var(--blue-bright);text-decoration:none;">Let's talk about what's possible.</a></p></div>
      </div>
    </div>
  </div></section>
      ...
      <form class="contact-form" action="https://formspree.io/f/xaqabrdo" method="POST">
        ...
        <div class="form-group">
          ...
          <select name="property_type">
            ...
            <option>Lakefront Property</option>
            <option>HOA / Community</option>
            <option>Commercial / Multi-Building</option>
            <option>Other</option>
          </select>
        </div>
        <div class="form-group"><label>Tell us about your fountain and property</label><textarea name="message" placeholder="What kind of fountain do you have? How far is it from the house? Any other details about your setup..."></textarea></div>
  ...
  // Cycling notification toast — 2 notifications
  (function() {
    ...
    toast.style.transition = 'opacity 0.4s ease, border-color 0.6s ease, box-shadow 0.6s ease';
    ...
    function loop() {
      // Show schedule (green) for DISPLAY ms
      setTimeout(function() {
        toast.style.opacity = '0';
        setTimeout(function() {
          // Swap to wind — already red
          setRed();
          icon.textContent = '🌬️';
          title.textContent = 'Wind Protection Activated';
          sub.textContent = 'Wind gust 24 mph · 2:17 PM';
          badge.textContent = '⛔ Shutoff';
          toast.style.opacity = '1';

          // Show wind (red) for DISPLAY ms
          setTimeout(function() {
            toast.style.opacity = '0';
            setTimeout(function() {
              // Swap back to schedule (green)
              setGreen();
              icon.textContent = '⛲';
              title.textContent = 'Sunset mode activated';
              sub.textContent = 'Fountain & LEDs on · 7:32 PM';
